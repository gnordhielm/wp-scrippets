...
// Options & Admin Stuff
$default_options  = array('width' => 'auto', 'bg_color' => '#FFFFFC', 'text_color' => '#000000', 'border_style' => 'Simple', 'alignment' => 'Left');
...
*/    	
    ...
    if (stristr($_SERVER['HTTP_USER_AGENT'], 'iPhone')) {   // need to modify the font to work with the iPhone
        echo "<style>\n\t.xscrippet p { font: 7px/9px Courier, 'Courier New', monospace !important; }\n\tdiv.scrippet { width: 220px !important; }</style>\n\n";
